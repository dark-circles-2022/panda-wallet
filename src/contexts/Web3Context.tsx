...
// 0xd52dBd85B950c8bFD4ba4e12800C66D08837609f - guardian harsh eoa
// 0xA49Ee42f15034882060851Db5c37180501248F7B - deployer
export const Web3ContextProvider: FC<PropsWithChildren> = ({ children }) => {
  ...
  const deployWallet = async () => {
    await deployerContract.deployAccount([eoaAddress], [recoveryFrens]);
  };
  ...
  return (
    <Web3Context.Provider
      value={{
        ...
        setRecoveryFrens,
        deployWallet,
        contractAddress: complexAccountContract?.address,
      }}
    >
      {children}
    </Web3Context.Provider>
